...
gulp.task('watch', [ 'inject', 'locales:watch' ], function() {
    ...
    // Bower dependencies.
    gulp.watch([ config.entry.html, 'bower.json' ], [ 'inject:reload' ]);
    ...
    gulp.watch(path.join(config.paths.app, '/', config.patterns.html), function(event) {
